...
%prep
%setup -q -n File-LibMagic-1.22
cd %{_builddir}
tar xf %{_sourcedir}/libfile-libmagic-perl_1.16-1.debian.tar.xz
cd %{_builddir}/File-LibMagic-1.22
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/File-LibMagic-1.22/deblicense/
...
cp %{_builddir}/File-LibMagic-1.22/LICENSE %{buildroot}/usr/share/package-licenses/perl-File-LibMagic/c24c1713d32e06b8b5935544493d7b40cefeb13e
